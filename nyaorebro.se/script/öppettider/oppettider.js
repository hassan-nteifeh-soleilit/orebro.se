...
var START_NODE_ID = '19.35481477149a719be3329e';
...
function printBusinessOpenHours(businessnes) {
   ...
   out.print("<div id=\"or-avc-wrapper\">\n");
   ...
   for (var k=0; k<businessnes.length; k++){ 
      ...
      out.print("  <div class=\"or-avc-wrapp collapsed\">\n");
      out.print("    <div class=\"or-avc-header\">\n");   
      out.print("      <div class=\"or-avc-" + cOpen + "\">" + cStatus + "</div>\n");   
      out.print("      <div class=\"or-avc-name\"><a class=\"or-avc-a\" href=\"#\">" + b.place + "</a></div>\n");
      out.print("      <div class=\"or-avc-time-info\">" + b.nextHourInfo + "</div>\n");
      out.print("      <div class=\"or-avc-chevron collapsed\"><i class=\"fa fa-chevron-down fa-lg\"></i></div>\n");   
      out.print("    </div>\n");
      out.print("    <div class=\"or-avc-content\">\n");
   	out.print("      <div class=\"or-avc-column\">\n");
   	
      printNextDaysTable(b);
   	
      out.print("      </div>\n");
      out.print("      <div class=\"or-avc-column\">\n");
      out.print("        <div class=\"or-avc-button b1\"><i class=\"fa fa-calendar fa-lg\"></i><a class=\"or-avc-a\" href=\"#\">Välj ett datum</a></div>\n");
   	out.print("        <div class=\"or-avc-content\">\n");
   	out.print("          <div class=\"or-avc-datePicker\" id=\"" + place + "\"></div>\n");  
      out.print("          <input type=\"hidden\" id=\"validto-" + place + "\" value=\"" + b.validto + "\"/>");  
   	out.print("          <div class=\"or-avc-datePickerOutput\" id=\"datePickerOutput-" + place + "\"></div>\n"); 
   	out.print("        </div>\n");
      if(b.mapLink) {
   	  out.print("        <div class=\"or-avc-button b2\"><i class=\"fa fa-map-marker fa-lg\"></i><a class=\"or-avc-a\" href=\"" + b.mapLink + "\">Visa på kartan (" + b.address + ")</a></div>\n");      
      }
      out.print("      </div>\n");
      out.print("    </div>\n");
      out.print("  </div>\n");            
...
function printNextDaysTable(business){
   ...
   if(business.nextDays.length > 0) { 
      out.print('        <table class="or-avc-openhours">\n');
...
function isDayRuleValid (drDay, inDay){
   ...
   for(var i=0; i<inDay.length && !validRule; i++){
      var dayRuleLength = inDay[i].length;
      var dayName = inDay[i].substr(dayRuleLength-2, dayRuleLength);      
