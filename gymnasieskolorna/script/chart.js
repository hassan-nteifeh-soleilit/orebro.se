   ...
   Chart.types.Doughnut.extend({
      ...
      draw: function() {
			...
			for(var i = 0; i < this.segments.length; i++){						
				...
				var r = 11; // radius for label container
				
				this.chart.ctx.beginPath();
				this.chart.ctx.arc(x, y, r, 0, 2 * Math.PI, false);
				
				this.chart.ctx.fillStyle = this.options.labelFill;            
				this.chart.ctx.fill();            
				this.chart.ctx.lineWidth = 1;            
				this.chart.ctx.strokeStyle = this.options.labelStroke;      
				this.chart.ctx.stroke();
            
                                    
				this.chart.ctx.font = 'bold 10pt Leaguespartan webfont';
				this.chart.ctx.fillStyle = this.options.labelStroke;
				this.chart.ctx.textAlign = 'center';
				this.chart.ctx.textBaseline = 'middle';
				this.chart.ctx.fillText(i+1, x, y+1);							
